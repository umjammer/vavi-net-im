...
//System.err.println(password + " " + new String(crypt_result));
//System.err.println(new String(password_hash) + " " + new String(crypt_hash));
...
// Debug.println("hash_string_p: " + hash_string_p);
// Debug.println("hash_string_c: " + hash_string_c);
        md5 = MessageDigest.getInstance("MD5");
